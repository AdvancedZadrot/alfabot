...
$get = http("https://api.telegram.org/bot484226037:AAHI3AnWGUdPX0kpUc5iSwpA5HsnB0nfw3s/getUpdates");.$l = iconv('cp1251','UTF-8', "Последнее сообщение:");
//echo "$l <b>".$get[result][count($get[result])-1][message][text]."</b> writed by <b>".$get[result][count($get[result])-1][message][chat][username];
//if (preg_match('/Прив/', iconv('UTF-8', 'cp1251', $get[result][count($get[result])-1][message][text]), $a)){}
